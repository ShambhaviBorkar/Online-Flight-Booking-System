...
<div class="flex-container">
    <div class="login-form mt-5" style="height: 350px;">
        ...
        <div class="alert text-center alert-info mb-0" 
            ...
            An email will be sent to you with the instructions on how to reset the password.
        </div>
...
<?php
// Safe and fixed error/message handling
if (isset($_GET['err'])) {
    if ($_GET['err'] === 'invalidemail') {
        ...
        echo '<script>alert("An error occurred while sending the email.");</script>';
    }
}
